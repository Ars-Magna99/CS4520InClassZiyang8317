...
public class InClass09SelectImgActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_in_class09_select_img);
    ...
    private void uploadImage(){
        final ProgressDialog pd = new ProgressDialog(InClass09SelectImgActivity.this);
            ...
            uploadTask.continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@NonNull Task<Uri> task) {
                    if (task.isSuccessful()){
                        ...
                        Toast.makeText(InClass09SelectImgActivity.this, "Failed!", Toast.LENGTH_SHORT).show();
                        pd.dismiss();
                    }
                }
                ...
                public void onFailure(@NonNull Exception e) {
                    Toast.makeText(InClass09SelectImgActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                    pd.dismiss();
                }
            });
        } else {
            Toast.makeText(InClass09SelectImgActivity.this, "No image selected", Toast.LENGTH_SHORT).show();
        }
    }
    @Override
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1 && data != null){
            ...
            Log.d("final", "onActivityResult: " + "set img!!"+String.valueOf(imageUri));
             ...
             Toast.makeText(InClass09SelectImgActivity.this, "Upload in preogress", Toast.LENGTH_SHORT).show();
             } else {
                 uploadImage();
                 onBackPressed();
             }
